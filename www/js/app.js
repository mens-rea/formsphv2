  ...
  $ionicPlatform.ready(function() {
    ...
    /*if(window.cordova) {
      ...
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (4,'dti',0,8,7,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (5,'gsis',0,4,2,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (6,'marriage',0,3,2,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (7,'nbi',0,4,2,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (8,'birth',0,3,3,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
      ...
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (12,'philhealth',0,3,2,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (13,'passport',0,7,38,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
      //finalize passportrenew
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (14,'passportrenew',0,8,8,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
      ...
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (20,'tin',0,4,2,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
      var query = "INSERT INTO documents (id, docname, prog, proc, req, checkreq) VALUES (21,'postal',0,4,3,0)";
        $cordovaSQLite.execute(db, query).then(function(res) { }, function (err) {});
...
.state('app.pdos', {
  ...
  .state('app.postal', {
    ...
    views: {
      'menuContent': {
        templateUrl: 'templates/app-postal.html',
      }
    }
  })
